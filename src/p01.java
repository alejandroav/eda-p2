...
*
* Se crea un objeto de tipo Palabra2 pasando null como segundo parametro.
* Se invoca su metodo setTrad para diferentes idiomas de manera que unas
* veces almacena la traduccion y otras no. Se invoca su metodo escribeInfo.
*/
public class p01 {
