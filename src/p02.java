...
*
* Se crea un objeto de tipo Palabra2 pasando un array de caracteres con un
* caracter para cada lengua a la que se puede traducir la palabra. Se invoca
* su metodo setTrad para alguna de las lenguas; se invoca su método getTraduccion
